...
import { MsgHMAC, TokAlg } from "../../../types/types.js";
import { Token } from "../../../models/models.js";
const hashHMAC = (payload) => crypto.createHmac(TokAlg.SHA, mySign).update(payload).digest("hex");
...
export const checkHMAC = (_a) => __awaiter(void 0, [_a], void 0, function* ({ user, token, event, }) {
    ...
    if (((_b = existingToken === null || existingToken === void 0 ? void 0 : existingToken.expiry) !== null && _b !== void 0 ? _b : 0) < Date.now()) {
        yield existingToken.destroy();
