...
export const genTokenJWE = (user) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (!count) yield genPairRSA();
    const publicKey = yield getPublicRSA();
    const payload = user.makePayload();
    const encrypted = yield new CompactEncrypt(
