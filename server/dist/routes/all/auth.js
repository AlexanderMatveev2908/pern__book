...
import { loginUser, logoutUser, registerUser, } from "../../controllers/auth/post.js";
...
authRouter.patch("/recover-account", limitRoute({ max: 15 }), validateChoseNewPwd, wrapApp(choseNewPwdForgotOld));
