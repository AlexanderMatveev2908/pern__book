...
(function (MsgErrSession) {
    MsgErrSession["ACCESS_EXPIRED"] = "ACCESS TOKEN EXPIRED";
    MsgErrSession["ACCESS_INVALID"] = "ACCESS_TOKEN_INVALID";
    MsgErrSession["ACCESS_NOT_PROVIDED"] = "ACCESS TOKEN NOT PROVIDED";
    MsgErrSession["REFRESH_EXPIRED"] = "REFRESH TOKEN EXPIRED";
    MsgErrSession["REFRESH_INVALID"] = "REFRESH TOKEN INVALID";
    MsgErrSession["REFRESH_NOT_PROVIDED"] = "REFRESH TOKEN NOT PROVIDED";
