  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col items-start scrollbar__app scrollbar__y overflow-y-auto max-h-full">
        ...
        <div className="grid grid-cols-[65px_3px_1fr] sm:grid-cols-[75px_3px_1fr] md:grid-cols-[1fr_3px_2fr]  scrollbar__app scrollbar__y overflow-y-auto  max-h-full w-full">
