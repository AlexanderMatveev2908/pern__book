...
const ErrorFormField: FC<PropsType> = ({ errors, el }) => {
  ...
  return (
    <div
      className={`absolute -top-[100%] right-0 transition-all pointer-events-none duration-[0.4s] text-red-600 border-2 border-red-600 rounded-xl py-1 px-5 bg-[#000] z-40 ${
