...
const CheckRegPwd: FC<PropsType> = ({ pwd, focus }) => {
  ...
  return (
    <div
      className={`w-full grid sm:grid-cols-[1fr_100px] gap-y-5 absolute el__border_sm z_check_pwd_span bg-[#000] p-3  left-0 top-[120%] pointer-events-none transition-all duration-500 ${
