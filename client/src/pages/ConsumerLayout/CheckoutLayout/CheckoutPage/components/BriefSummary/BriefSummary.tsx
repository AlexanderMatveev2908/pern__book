  ...
  return (
    ...
    >
      ...
      <div className="w-full max-w-[500px] sm:max-w-[600px] border-[3px] border-neutral-800 rounded-xl gap-y-6 grid grid-cols-1 ">
        <div className="w-full sticky top-0 bg-neutral-950 z-60 grid grid-cols-1 pb-2 border-b-2 border-blue-600 py-2">
          <WrapPairTxt
            {...{
        ...
        <div className="max-h-[325px] overflow-y-auto scroll_app scroll_y flex flex-col gap-y-6  pb-10 px-4">
